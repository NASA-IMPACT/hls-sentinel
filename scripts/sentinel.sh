...
set_outputs () {
  ...
  outputname="HLS.S30.${granulecomponents[5]:1:5}.${year}${day_of_year}.v1.5"
  output="${workingdir}/output/${outputname}"
  output_hdr="${output}.hdr"
  echo $output
}
