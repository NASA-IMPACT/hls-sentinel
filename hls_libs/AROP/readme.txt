...
gzip -d public_AROP_v2.2.7.tar.gz
tar -xvf public_AROP_v2.2.7.tar
cd public_AROP_v2.2.7
source env.sh
make
make install

You will see an executable program named "ortho" under sub-directory 
"public_AROP_v2.2.7/bin" if programs were compiled successfully.
...
11. To save control points and polynomial functions, simply define "CP_LOG_FILE ="
 in input parameter file

12. To extract control points without doing resampling, use "RESAMPLE_METHOD = none"
